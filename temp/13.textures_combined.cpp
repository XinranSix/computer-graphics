...
int main() {
    ...
    // ------------------------------------
    Shader ourShader("asset/shader/learnopengl/12.texture.vs", "asset/shader/learnopengl/12.texture.fs");
    ...
    Texture texture { "asset/texture/container.jpg", 0,true, data };
    Texture texture2 { "asset/texture/awesomeface.png", 1,true, data };
