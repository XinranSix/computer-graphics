...
int main() {
    ...
    // ------------------------------------
    Shader ourShader("asset/shader/learnopengl/11.texture.vs", "asset/shader/learnopengl/13.textures_exercise1.fs");
    ...
    unsigned char *data = stbi_load("asset/texture/awesomeface.png", &width, &height, &nrChannels, 0);
    if (data) {
