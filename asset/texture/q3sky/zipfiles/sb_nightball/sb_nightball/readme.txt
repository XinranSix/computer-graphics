=======================================================
Date:             25th of October 2001.
file:             sb-nightballtga.zip
author:           Sock 
...
Instructions for using the NightBall Skybox
-------------------------------------------
...
4. Close the file and open Q3Radiant and you should
   find on the texture menu the NIGHTBALL subdirectory.
   
5. Choose the NIGHTBALL subdirectory and you should find
   the sky texture ready for use.
   
6. If the editor displays 2 textures use the one
   called NIGHTBALL_SKYBOX. The other one is just so
