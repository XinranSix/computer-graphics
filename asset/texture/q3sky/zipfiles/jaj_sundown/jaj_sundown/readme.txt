...
3. Add this line at the bottom of the text: "jajsundown1" (without the
   quotes). 
   Save and close it.
...
The "jajsundown1.shader" file, provides a default colour, intensity,
