...
#pragma region shader
    Shader ourShader("./asset/shader/learnopengl/9.shaders_exercise1/9.shaders_exercise1.vs",
                     "./asset/shader/learnopengl/9.shaders_exercise1/9.shaders_exercise1.fs");
#pragma endregion
