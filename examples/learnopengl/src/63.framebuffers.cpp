...
#pragma region shader
    ...
    Shader screenShader { "asset/shader/learnopengl/63.framebuffers/63.framebuffers_screen.vs",
                          "asset/shader/learnopengl/63.framebuffers/63.framebuffers_screen.fs" };
#pragma endregion
...
#pragma region loop
    while (!glfwWindowShouldClose(window)) {
        if (reload_shader) {
            shader = { "asset/shader/learnopengl/63.framebuffers/63.framebuffers.vs",
                       "asset/shader/learnopengl/63.framebuffers/63.framebuffers.fs" };
            screenShader = { "asset/shader/learnopengl/63.framebuffers/63.framebuffers_screen.vs",
                             "asset/shader/learnopengl/63.framebuffers/63.framebuffers_screen.fs" };
            reload_shader = false;
        }
