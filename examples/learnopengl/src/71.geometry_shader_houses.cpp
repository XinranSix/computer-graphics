...
#pragma region shader
    auto shader { std::make_shared<Shader>(
        "asset/shader/learnopengl/71.geometry_shader_houses/71.geometry_shader.vs",
        "asset/shader/learnopengl/71.geometry_shader_houses/71.geometry_shader.fs") };
    ...
    try {
        // open files
        gShaderFile.open("asset/shader/learnopengl/71.geometry_shader_houses/71.geometry_shader.gs");
