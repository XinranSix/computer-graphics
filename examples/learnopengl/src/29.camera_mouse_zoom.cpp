...
#pragma region shader
    Shader ourShader { "./asset/shader/learnopengl/29.camera_mouse_zoom/29.camera_mouse_zoom.vs",
                       "./asset/shader/learnopengl/29.camera_mouse_zoom/29.camera_mouse_zoom.fs" };
#pragma endregion
...
#pragma region loop
    while (!glfwWindowShouldClose(window)) {
        ...
        auto projection { glm::perspective(glm::radians(fov), static_cast<float>(SCR_WIDTH) / SCR_HEIGHT, 0.1f,
                                           100.0f) };
        ourShader.use();
...
#pragma region imgui render
        ...
        ImGui::DragFloat("Camera Speed", &camera_speed, 0.01f, 0.001f, 1000.0f);
