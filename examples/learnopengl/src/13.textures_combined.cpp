...
#pragma region shader
    Shader ourShader { "./asset/shader/learnopengl/13.textures_combined/13.textures_combined.vs",
                       "./asset/shader/learnopengl/13.textures_combined/13.textures_combined.fs" };
#pragma endregion
