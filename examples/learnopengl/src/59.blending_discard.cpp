...
#pragma region shader
    Shader shader { "asset/shader/learnopengl/59.blending_discard/59.blending_discard.vs",
                    "asset/shader/learnopengl/59.blending_discard/59.blending_discard.fs" };
#pragma endregion
...
#pragma region texture
    ...
    GLuint grassTexture = loadTexture("asset/texture/grass.png");
