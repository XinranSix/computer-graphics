...
#pragma region shader
    Shader ourShader { "./asset/shader/learnopengl/21.coordinate_systems/21.coordinate_systems.vs",
                       "./asset/shader/learnopengl/21.coordinate_systems/21.coordinate_systems.fs" };
#pragma endregion

#pragma region data_and_buffer
    float background_color[] { 0.7137f, 0.7333f, 0.7686f, 1.0f };
    bool wire_mode { false };
    auto model { glm::rotate(glm::mat4 { 1.0f }, glm::radians(-55.0f), { 1.0f, 0.0f, 0.0f }) };
    auto view { glm::translate(glm::mat4 { 1.0f }, { 0.0f, 0.0f, -3.0f }) };
    auto projection { glm::perspective(glm::radians(45.0f), static_cast<float>(SCR_WIDTH) / SCR_HEIGHT, 0.1f, 100.0f) };
