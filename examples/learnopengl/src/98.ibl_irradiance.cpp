...
#pragma region shader
    Shader pbrShader("asset/shader/learnopengl/98.ibl_irradiance/98.pbr.vs",
                     "asset/shader/learnopengl/98.ibl_irradiance/98.pbr.fs");
    Shader equirectangularToCubemapShader(
        "asset/shader/learnopengl/98.ibl_irradiance/98.cubemap.vs",
        "asset/shader/learnopengl/98.ibl_irradiance/98.equirectangular_to_cubemap.fs");
    Shader irradianceShader("asset/shader/learnopengl/98.ibl_irradiance/98.cubemap.vs",
                            "asset/shader/learnopengl/98.ibl_irradiance/98.irradiance_convolution.fs");
    Shader backgroundShader("asset/shader/learnopengl/98.ibl_irradiance/98.background.vs",
                            "asset/shader/learnopengl/98.ibl_irradiance/98.background.fs");
