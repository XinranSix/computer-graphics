...
#pragma region shader
    Shader ourShader {
        "./asset/shader/learnopengl/25.coordinate_systems_exercise2/25.coordinate_systems_exercise2.vs",
        "./asset/shader/learnopengl/25.coordinate_systems_exercise2/25.coordinate_systems_exercise2.fs"
    };
#pragma endregion
...
#pragma region loop
    while (!glfwWindowShouldClose(window)) {
        ...
        auto view { glm::translate(glm::mat4 { 1.0f }, -offset) };
