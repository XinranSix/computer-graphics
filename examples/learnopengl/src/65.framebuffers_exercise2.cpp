...
#pragma region shader
    Shader shader { "asset/shader/learnopengl/65.framebuffers_exercise2/65.framebuffers_exercise2.vs",
                    "asset/shader/learnopengl/65.framebuffers_exercise2/65.framebuffers_exercise2.fs" };
    Shader screenShader { "asset/shader/learnopengl/65.framebuffers_exercise2/65.framebuffers_screen.vs",
                          "asset/shader/learnopengl/65.framebuffers_exercise2/65.framebuffers_screen.fs" };
#pragma endregion
