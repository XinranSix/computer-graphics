...
#pragma region shader
    Shader ourShader { "./asset/shader/learnopengl/32.camera-exercise2/32.camera-exercise2.vs",
                       "./asset/shader/learnopengl/32.camera-exercise2/32.camera-exercise2.fs" };
#pragma endregion
