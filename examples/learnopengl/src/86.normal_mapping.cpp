...
int main() {
    ...
    // -------------------------
    Shader shader { "asset/shader/learnopengl/86.normal_mapping/86.normal_mapping.vs",
                    "asset/shader/learnopengl/86.normal_mapping/86.normal_mapping.fs" };

    // load textures
    // -------------
    // load textures
    // -------------
    unsigned int diffuseMap = loadTexture("asset/texture/brickwall.jpg");
    unsigned int normalMap = loadTexture("asset/texture/brickwall_normal.jpg");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        model = glm::rotate(model, glm::radians((float)glfwGetTime() * -10.0f),
                            glm::normalize(glm::vec3(
                                1.0, 0.0, 1.0))); // rotate the quad to show normal mapping from multiple directions
