...
#pragma region shader
    Shader pbrShader("asset/shader/learnopengl/97.ibl_irradiance_conversion/97.pbr.vs",
                     "asset/shader/learnopengl/97.ibl_irradiance_conversion/97.pbr.fs");
    Shader equirectangularToCubemapShader(
        "asset/shader/learnopengl/97.ibl_irradiance_conversion/97.cubemap.vs",
        "asset/shader/learnopengl/97.ibl_irradiance_conversion/97.equirectangular_to_cubemap.fs");
    Shader backgroundShader("asset/shader/learnopengl/97.ibl_irradiance_conversion/97.background.vs",
                            "asset/shader/learnopengl/97.ibl_irradiance_conversion/97.background.fs");
