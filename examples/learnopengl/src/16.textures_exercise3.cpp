...
#pragma region shader
    Shader ourShader { "./asset/shader/learnopengl/16.textures_exercise3/16.textures_exercise3.vs",
                       "./asset/shader/learnopengl/16.textures_exercise3/16.textures_exercise3.fs" };
#pragma endregion
...
#pragma region data_and_buffer
    ...
    // ------------------------------------------------------------------
    float vertices[] = {
        // positions          // colors           // texture coords (note that we changed them to 'zoom in' on our
        // texture image)
...
#pragma region imgui render
        ...
        ImGui::NewLine();
        ImGui::DragFloat2("offset", glm::value_ptr(offset), 0.001, -0.5, 0.5);
