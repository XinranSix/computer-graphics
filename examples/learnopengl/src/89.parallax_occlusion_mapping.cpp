...
int main() {
    ...
    // -------------------------
    Shader shader("asset/shader/learnopengl/89.parallax_occlusion_mapping/89.parallax_occlusion_mapping.vs",
                  "asset/shader/learnopengl/89.parallax_occlusion_mapping/89.parallax_occlusion_mapping.fs");

    // load textures
    // -------------
    unsigned int diffuseMap = loadTexture("asset/texture/bricks2.jpg");
    unsigned int normalMap = loadTexture("asset/texture/bricks2_normal.jpg");
    unsigned int heightMap = loadTexture("asset/texture/bricks2_disp.jpg");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        model = glm::rotate(model, glm::radians((float)glfwGetTime() * -10.0f),
                            glm::normalize(glm::vec3(
                                1.0, 0.0, 1.0))); // rotate the quad to show parallax mapping from multiple directions
