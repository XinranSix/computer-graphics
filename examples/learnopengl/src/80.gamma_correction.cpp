...
#pragma region shader
    auto shader { std::make_shared<Shader>("asset/shader/learnopengl/80.gamma_correction/80.gamma_correction.vs",
                                           "asset/shader/learnopengl/80.gamma_correction/80.gamma_correction.fs") };
    ...
    // load textures
    // -------------
    unsigned int floorTexture = loadTexture("asset/texture/wood.png", false);
    unsigned int floorTextureGammaCorrected = loadTexture("asset/texture/wood.png", true);
