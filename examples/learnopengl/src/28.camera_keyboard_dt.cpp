...
#pragma region shader
    Shader ourShader { "./asset/shader/learnopengl/28.camera_keyboard_dt/28.camera_keyboard_dt.vs",
                       "./asset/shader/learnopengl/28.camera_keyboard_dt/28.camera_keyboard_dt.fs" };
#pragma endregion
