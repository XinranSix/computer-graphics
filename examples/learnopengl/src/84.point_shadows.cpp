...
int main() {
    ...
    // -------------------------
    Shader shader { "asset/shader/learnopengl/84.point_shadows/84.point_shadows.vs",
                    "asset/shader/learnopengl/84.point_shadows/84.point_shadows.fs" };
    Shader simpleDepthShader { "asset/shader/learnopengl/84.point_shadows/84.point_shadows_depth.vs",
                               "asset/shader/learnopengl/84.point_shadows/84.point_shadows_depth.fs",
                               "asset/shader/learnopengl/84.point_shadows/84.point_shadows_depth.gs" };
