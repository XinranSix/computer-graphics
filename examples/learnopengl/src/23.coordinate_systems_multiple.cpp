...
#pragma region shader
    Shader ourShader { "./asset/shader/learnopengl/23.coordinate_systems_multiple/23.coordinate_systems_multiple.vs",
                       "./asset/shader/learnopengl/23.coordinate_systems_multiple/23.coordinate_systems_multiple.fs" };
#pragma endregion
