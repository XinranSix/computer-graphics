...
#pragma region shader
    auto shader { std::make_shared<Shader>("asset/shader/learnopengl/79.advanced_lighting/79.advanced_lighting.vs",
                                           "asset/shader/learnopengl/79.advanced_lighting/79.advanced_lighting.fs") };
