...
#pragma region shader
    Shader ourShader { "./asset/shader/learnopengl/22.coordinate_systems_depth/22.coordinate_systems_depth.vs",
                       "./asset/shader/learnopengl/22.coordinate_systems_depth/22.coordinate_systems_depth.fs" };
#pragma endregion
