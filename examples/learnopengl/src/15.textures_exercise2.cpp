...
#pragma region shader
    Shader ourShader { "./asset/shader/learnopengl/15.textures_exercise2/15.textures_exercise2.vs",
                       "./asset/shader/learnopengl/15.textures_exercise2/15.textures_exercise2.fs" };
#pragma endregion
