...
#pragma region shader
    Shader lightingShader("asset/shader/learnopengl/48.lighting_maps_exercise4/48.lighting_maps_exercise4.vs",
                          "asset/shader/learnopengl/48.lighting_maps_exercise4/48.lighting_maps_exercise4.fs");
    Shader lightCubeShader("asset/shader/learnopengl/48.lighting_maps_exercise4/48.light_cube.vs",
                           "asset/shader/learnopengl/48.lighting_maps_exercise4/48.light_cube.fs");
#pragma endregion
...
#pragma region texture
    ...
    unsigned int emissionMap = loadTexture("asset/texture/matrix.jpg");
