...
#pragma region shader
    Shader shader { "asset/shader/learnopengl/57.depth_testing_view/57.depth_testing_view.vs",
                    "asset/shader/learnopengl/57.depth_testing_view/57.depth_testing_view.fs" };
#pragma endregion
