...
int main() {
    ...
    // -------------------------
    Shader shader("asset/shader/learnopengl/88.steep_parallax_mapping/88.steep_parallax_mapping.vs",
                  "asset/shader/learnopengl/88.steep_parallax_mapping/88.steep_parallax_mapping.fs");
