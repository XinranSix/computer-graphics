...
#pragma region shader
    auto shader { std::make_shared<Shader>(
        "asset/shader/learnopengl/78.anti_aliasing_offscreen/78.anti_aliasing_offscreen.vs",
        "asset/shader/learnopengl/78.anti_aliasing_offscreen/78.anti_aliasing_offscreen.fs") };
