...
#pragma region shader
    Shader ourShader { "./asset/shader/learnopengl/17.textures_exercise4/17.textures_exercise4.vs",
                       "./asset/shader/learnopengl/17.textures_exercise4/17.textures_exercise4.fs" };
#pragma endregion
...
#pragma region imgui render
        ...
        ImGui::DragFloat("mixValue", &mixValue, 0.001f, 0.0f, 1.0f);
