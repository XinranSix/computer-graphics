...
#pragma region shader
    Shader lightingShader("asset/shader/learnopengl/42.materials_exercise1/42.materials_exercise1.vs",
                          "asset/shader/learnopengl/42.materials_exercise1/42.materials_exercise1.fs");
    Shader lightCubeShader("asset/shader/learnopengl/42.materials_exercise1/42.light_cube.vs",
                           "asset/shader/learnopengl/42.materials_exercise1/42.light_cube.fs");
#pragma endregion
...
#pragma region loop
    while (!glfwWindowShouldClose(window)) {
        ...
        /* material.diffuse = lightColor * glm::vec3(0.5f);       // 降低影响
        material.ambient = material.diffuse * glm::vec3(0.2f); // 很低的影响 */
