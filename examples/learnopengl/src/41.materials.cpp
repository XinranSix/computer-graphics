...
#pragma region shader
    Shader lightingShader("asset/shader/learnopengl/41.materials/41.materials.vs",
                          "asset/shader/learnopengl/41.materials/41.materials.fs");
    Shader lightCubeShader("asset/shader/learnopengl/41.materials/41.light_cube.vs",
                           "asset/shader/learnopengl/41.materials/41.light_cube.fs");
#pragma endregion
...
#pragma region loop
    while (!glfwWindowShouldClose(window)) {
        ...
        lightingShader.setVec3("material.ambient", 1.0f, 0.5f, 0.21f);
        lightingShader.setVec3("material.diffuse", 1.0f, 0.5f, 0.21f);
