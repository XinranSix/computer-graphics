...
#pragma region shader
    Shader ourShader { "./asset/shader/learnopengl/11.shaders_exercise3/11.shaders_exercise3.vs",
                       "./asset/shader/learnopengl/11.shaders_exercise3/11.shaders_exercise3.fs" };
#pragma endregion
