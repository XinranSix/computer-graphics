...
int main() {
    ...
    // -------------------------
    Shader ourShader("asset/shader/learnopengl/103.frustum_culling/103.model_loading.vs",
                     "asset/shader/learnopengl/103.frustum_culling/103.model_loading.fs");

    // load models
    // -----------
    Model model = Model("asset/model/planet/planet.obj");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        const Frustum camFrustum = createFrustumFromCamera(camera, (float)SCR_WIDTH / (float)SCR_HEIGHT,
                                                           glm::radians(camera.Zoom), 0.1f, 100.0f);
