...
#pragma region shader
    Shader lightingShader("asset/shader/learnopengl/33.colors/33.colors.vs",
                          "asset/shader/learnopengl/33.colors/33.colors.fs");
    Shader lightCubeShader("asset/shader/learnopengl/33.colors/33.light_cube.vs",
                           "asset/shader/learnopengl/33.colors/33.light_cube.fs");
#pragma endregion
