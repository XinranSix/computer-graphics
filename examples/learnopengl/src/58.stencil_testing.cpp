...
#pragma region shader
    Shader shader { "asset/shader/learnopengl/58.stencil_testing/58.stencil_testing.vs",
                    "asset/shader/learnopengl/58.stencil_testing/58.stencil_testing.fs" };
    Shader shaderSingleColor("asset/shader/learnopengl/58.stencil_testing/58.stencil_testing.vs",
                             "asset/shader/learnopengl/58.stencil_testing/58.stencil_single_color.fs");
#pragma endregion
...
#pragma region imgui render
        ...
        if (ImGui::CollapsingHeader("Window options")) {
            ...
            ImGui::RadioButton("Zero", &select, 0);
            ImGui::SameLine();
            ImGui::RadioButton("One", &select, 1);
            ImGui::SameLine();
            ImGui::RadioButton("Two", &select, 2);
            ImGui::SameLine();
            ImGui::RadioButton("Three", &select, 3);
        }
