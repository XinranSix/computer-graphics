...
#pragma region shader
    Shader shader { "asset/shader/learnopengl/64.framebuffers_exercise1/64.framebuffers_exercise1.vs",
                    "asset/shader/learnopengl/64.framebuffers_exercise1/64.framebuffers_exercise1.fs" };
    Shader screenShader { "asset/shader/learnopengl/64.framebuffers_exercise1/64.framebuffers_screen.vs",
                          "asset/shader/learnopengl/64.framebuffers_exercise1/64.framebuffers_screen.fs" };
#pragma endregion
...
#pragma region loop
    while (!glfwWindowShouldClose(window)) {
        ...
        /* camera.ProcessMouseMovement(
            0, 0, false);  */// call this to make sure it updates its camera vectors, note that we disable pitch constrains
