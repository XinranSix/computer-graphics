...
#pragma region shader
    Shader ourShader { "./asset/shader/learnopengl/26.coordinate_systems_exercise3/26.coordinate_systems_exercise3.vs",
                       "./asset/shader/learnopengl/26.coordinate_systems_exercise3/26.coordinate_systems_exercise3.fs" };
#pragma endregion
