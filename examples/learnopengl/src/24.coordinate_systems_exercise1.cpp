...
#pragma region shader
    Shader ourShader {
        "./asset/shader/learnopengl/24.coordinate_systems_exercise1/24.coordinate_systems_exercise1.vs",
        "./asset/shader/learnopengl/24.coordinate_systems_exercise1/24.coordinate_systems_exercise1.fs"
    };
#pragma endregion
...
#pragma region data_and_buffer
    ...
    float fov { 45.0f };
    float aspect_ratio { static_cast<float>(SCR_WIDTH) / SCR_HEIGHT };
...
#pragma region loop
    while (!glfwWindowShouldClose(window)) {
        ...
        // auto model { glm::rotate(glm::mat4 { 1.0f }, (float)glfwGetTime(), glm::vec3(0.5f, 1.0f, 0.0f)) };
        auto view { glm::translate(glm::mat4 { 1.0f }, { 0.0f, 0.0f, -3.0f }) };
        auto projection { glm::perspective(glm::radians(fov), aspect_ratio, 0.1f, 100.0f) };
        ourShader.use();
...
#pragma region imgui render
        ...
        ImGui::DragFloat("FoV", &fov, 0.1f, 0.0f, 360.0f);
        ImGui::DragFloat("aspect ratio", &aspect_ratio, 0.1f, 0.0001f, 1000.0f);
