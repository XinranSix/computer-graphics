...
#pragma region shader
    Shader pbrShader("asset/shader/learnopengl/99.ibl_specular/99.pbr.vs",
                     "asset/shader/learnopengl/99.ibl_specular/99.pbr.fs");
    Shader equirectangularToCubemapShader("asset/shader/learnopengl/99.ibl_specular/99.cubemap.vs",
                                          "asset/shader/learnopengl/99.ibl_specular/99.equirectangular_to_cubemap.fs");
    Shader irradianceShader("asset/shader/learnopengl/99.ibl_specular/99.cubemap.vs",
                            "asset/shader/learnopengl/99.ibl_specular/99.irradiance_convolution.fs");
    Shader prefilterShader("asset/shader/learnopengl/99.ibl_specular/99.cubemap.vs",
                           "asset/shader/learnopengl/99.ibl_specular/99.prefilter.fs");
    Shader brdfShader("asset/shader/learnopengl/99.ibl_specular/99.brdf.vs",
                      "asset/shader/learnopengl/99.ibl_specular/99.brdf.fs");
    Shader backgroundShader("asset/shader/learnopengl/99.ibl_specular/99.background.vs",
                            "asset/shader/learnopengl/99.ibl_specular/99.background.fs");
