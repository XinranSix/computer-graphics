...
#pragma region shader
    Shader ourShader { "./asset/shader/learnopengl/20.transformations_exercise2/20.transformations_exercise2.vs",
                       "./asset/shader/learnopengl/20.transformations_exercise2/20.transformations_exercise2.fs" };
#pragma endregion
...
#pragma region loop
    while (!glfwWindowShouldClose(window)) {
        ...
        auto scaleAmount { static_cast<float>(std::sin(glfwGetTime())) };
        trans = glm::scale(glm::mat4 { 1.0f }, { scaleAmount, scaleAmount, 1.0f });
        trans = glm::translate(trans, glm::vec3(-0.5f, 0.5f, 0.0f));
        ourShader.setMat4("transform", trans);
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
