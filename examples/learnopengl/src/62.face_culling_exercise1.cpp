...
#pragma region shader
    Shader shader { "asset/shader/learnopengl/62.face_culling_exercise1/62.face_culling_exercise1.vs",
                    "asset/shader/learnopengl/62.face_culling_exercise1/62.face_culling_exercise1.fs" };
#pragma endregion
...
#pragma region data_and_buffer
    ...
    glCreateVertexArrays(1, &vegetationVAO);
    glCreateBuffers(1, &vegetationVBO);
...
#pragma region imgui render
        ...
        if (ImGui::CollapsingHeader("Cull face")) {
            ImGui::RadioButton("Front", &cull_face, 0);
            ImGui::SameLine();
            ImGui::RadioButton("Back", &cull_face, 1);
            ImGui::SameLine();
            ImGui::RadioButton("Front and Back", &cull_face, 2);
        }
        if (ImGui::CollapsingHeader("Front face")) {
            ImGui::RadioButton("CW", &front_face, 0);
            ImGui::SameLine();
            ImGui::RadioButton("CCW", &front_face, 1);
        }
